...
BlizzPy currently supports the WoW Community API, SC2 Community API, and D3 Community API (for US, EU, and KR), with Game Data API and WoW Game Data API being added very soon.
